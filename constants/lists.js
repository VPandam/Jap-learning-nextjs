...
export const cardSyllableConst = {0:["a"], 1:["i"], 2:["u"], 3:["e"], 4:["o"], 5:["ka"], 6:["ki"],
     7:["ku"], 8:["ke"], 9:["ko"], 10:["sa"], 11:["shi"], 12:["su"], 
     13:["se"], 14:["so"], 15:["ta"], 16:["chi"], 17:["tsu"], 18:["te"],
    ...
    export const cardListLvlConst = {1:4, 2:9, 3:14, 4:19, 5:24, 6:29, 7:37, 8:45};